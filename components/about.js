        ...
        <div id="about">
          <div className={s.flexCentered}>
            <h2 className={s.aboutHeader}>
              ...
              <span className={s.aboutSimpleEnglish} lang="en">
                Simple English
              </span>
            </h2>
          ...
          <ul className={s.aboutList}>
            <li className={s.aboutListItem}>
              <img
                src="img/forAdults/1@2x.png"
                alt="Logo"
                className={s.about_images}
              />
              <span className={s.abouListText}>Інтерактивна платформа</span>
            </li>
            <li className={s.aboutListItem}>
              <img
                src="img/forAdults/2@2x.png"
                alt="Logo"
                className={s.about_images}
              />
            ...
            <li className={s.aboutListItem}>
              <img
                src="img/forAdults/5@2x.png"
                alt="Logo"
                className={s.about_images}
              />

              <span className={s.abouListText}>
                {' '}
                Чуйні та професійні викладачі
              </span>
            </li>
          </ul>
        </div>
