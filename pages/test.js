            ...
            <div className={s.score_section}>
              <div className={s.score_section_text}>
                <div className={s.score_section_text_header}>
                  ...
                  <p>
                  <b>0-3</b>  beginner <br></br>
                  <b>4-6</b>   elementary <br></br>
                  <b>7-12</b>  pre-intermediate <br></br>
                  <b>13-18</b> intermediate <br></br>
                  <b>19-21</b>  upper-intermediate <br></br>
                  <b>22</b>  advanced
                  </p>
                </div>

                <p>
                  <b>A0</b> - beginner Ви на початку шляху і тільки починаєте своє
                ...
                <p>
                  <b>А1 </b>- elementary You're not bad! Вже можна знайомитись з
                  іноземцями. Перші (найважливіші) кроки зроблені, настав час
                  підвищувати планку! Щоб не відкладати, пря
                </p>
                <p>
                <b>A2</b> - pre-intermediate Ваші знання англійської вже на досить
                  хорошому рівні. Тепер радимо розширювати словниковий запас та
                  вивчати складніші граматичні конструкції. Бажаємо
                  продуктивного навчання, яке ви можете розпочати разом з Simple
                  English.
                </p>
                <p>
                <b>B1</b> - intermediate Ви досягли базового середнього рівня
                  англійської. Але зупинятися рано, повна свобода мовлення ще
                  попереду. Більшість студентів не переходять до вищого рівня,
                  але ви зможете! Граматика, винятки з правил, читання
                  неадаптованої літератури та більше спілкування англійською
                  чекають на вас. Одними з дієвих способів є онлайн-листування
                  на форумах або в соціальних мережах з іноземцями, перегляд
                  улюблених фільмів або серіалів в оригіналі, прослуховування
                  музики. Викладачі Simple English обов'язково допоможуть вам у
                  досягненні лінгвістичних висот!
                </p>
                <p>
                <b>B2</b> - upper-intermediate У вас гарні знання англійської. Саме
                  час набратися терпіння і сфокусуватися на закріпленні знань у
                  розмовній практиці. Віддавайте перевагу автентичній
                  літературі, не вдаючись до допомоги англійсько-українського
                  словника, дивіться квізи, ток-шоу та наукові передачі
                  англійською. Все це ви можете спробувати на безкоштовному
                  уроці з викладачами Simple English!
                </p>
                <p>
                <b>C1</b> - Advanced Браво! Ви можете похвалитися своєю англійською.
              ...
              <button className={s.button} onClick={resetQuiz}>
                Пройти тест ще раз!
              </button>
            </div>
          ) : (
